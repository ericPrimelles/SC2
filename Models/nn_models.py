...
class DuelingFeatureCNNFCBig(nn.Module):
    """
    CNN model based on feature inputs
    """
    def __init__(self, n_features, screen_size=64):
        super(DuelingFeatureCNNFCBig, self).__init__()
        ...
        self.name = f'DuelingFeatureCNNFCBig{n_features}'
        self.screen_size = screen_size
    ...
    def forward(self, x):
        ...
        x = v + a - a.mean(1).unsqueeze(1).expand(x.size(0), self.screen_size**2)
        return x
